...
@ConfigurationProperties("mes-config")// cette annotation précise que la classe de configuration va récupérer des propriétés dans bootstrap.properties dont le préfixe est : mes-configs.
